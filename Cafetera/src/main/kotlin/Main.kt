...
fun main() {
    ...
    println("${cafetera1.llenar()} cafetera1 llena.")

    //TODO: Vaciar la cafetera2.
    println("${cafetera2.vaciar()} cafetera2 vacía.")

    //TODO: Agregar café a la cafetera2 a la mitad de su capacidad.
    println("${cafetera2.agregarCafe()} cafetera2 con café agregado.")

    //TODO: Agregar 400 c.c. de café a la cafereta3
    println("${cafetera3.agregarCafe()} agregado.")
